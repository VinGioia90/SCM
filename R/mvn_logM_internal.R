#' Family definition (logm) internal use
#'
#' @description  ...
#' @param d dimension of the outcome
#' @param l2 initialization of the hessian matrix (dimension n x no_eta x (no_eta+1)/2), with no_eta = d+d x (d + 1)/2
#'
#' @return family
#' @export
#'

---
title: 'An introduction to SCM: Fit an additive covariance matrix model for multivariate
  normal data '
...
output:
  ...
  pdf_document:
    toc: yes
vignette: |
  %\VignetteEngine{knitr::rmarkdown} %\VignetteIndexEntry{SCM} %\VignetteEncoding{UTF-8}
---
